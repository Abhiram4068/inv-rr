...
export const getCollections = (search = "", sortBy = "created_at", sortOrder = "desc", page = 1, pageSize = null) => 
  api.get("/collections/", { params: { search, sort_by: sortBy, sort_order: sortOrder, page, ...(pageSize ? { page_size: pageSize } : {}) } });
